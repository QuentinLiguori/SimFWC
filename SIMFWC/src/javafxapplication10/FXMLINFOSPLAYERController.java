 ...
 * @author utilisateur
 */
public class FXMLINFOSPLAYERController implements Initializable {
    @FXML
    private Label nom;
	...
	Player chiesa = new Player("Chiesa", "Federico", 22, 70, 175, "attaquant", 65, 28, 48, 81, 55, 76, 71, 27);
		...
		Team[] participant = { chili, uruguay, italy, portugal, sweden, poland, france, argentin, netherlands, morocco,
                ...
                for (Team team : participant) {
            Player [] player = team.getPlayers();
                    for (int i = 0; i < player.length; i++) {
                        Player player1 = player[i];
                        if(player1.getName()== value){
                            /*
                        InputStream input = getClass().getResourceAsStream(team.getFlag());
                        Image image = new Image(input);
                        ImageView imageView = new ImageView(image);
                        imageView.setFitWidth(40);
                        imageView.setFitHeight(30);
                        */
                            File input = new File(team.getFlag());
                        ...
                        File  inputback = new File ("C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\back.png");
                        Image imageback = new Image(inputback.toURI().toString());
                        ...
                        imageViewabck.setFitHeight(30);
                            ...
                            pays.setGraphic(imageView);
                            nom.setText(player1.getName()+" "+player1.getFirstName());
                            Label1.setText("Position : "+"  "+player1.getPosition());
                            Label2.setText("Age : "+"  "+player1.getAge()+" ans");
                            Label3.setText("Energie : "+"  "+player1.getEnergy());
                            Label4.setText("Taille : "+"  "+player1.getHeight()+" cm");
                            Label5.setText("Poids : "+"  "+player1.getWeight()+" Kg");
                            Label6.setText("Speed : "+"  "+player1.getSpeed());
                            pays.setText(team.getCountry());
                            setValue(team.getCountry());
    ...
    public void Getabck(ActionEvent event) throws IOException{
