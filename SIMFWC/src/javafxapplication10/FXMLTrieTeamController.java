 ...
 * @author utilisateur
 */
public class FXMLTrieTeamController implements Initializable {
    ...
    @FXML
    private Button team12;
    
    @FXML
    private Button team13;
    
    @FXML
    private Button team14;
    
    @FXML
    private Button team15;
    
    @FXML
    private Button team16;
    
    @FXML
    private  Button Button1,Button2,Button3,Button4,Button15,Button16,Button17,Button18,Button19,Button110,Button111,Button112,Button113,Button114,Button115,Button116,Button117,Button118,Button119,Button120,Button121,Button123;
       @FXML
    private Label l1;
    ...
    public void classement() throws IOException{
	...
	Player chiesa = new Player("Chiesa", "Federico", 22, 70, 175, "attaquant", 65, 28, 48, 81, 55, 76, 71, 27);
		...
		Team[] participant = { chili, uruguay, italy, portugal, sweden, poland, france, argentin, netherlands, morocco,
				england, germany, algeria, belgique, bresil, spain };
                	...
                	Comparator<Team> byAge = Comparator.comparing(Team::getScoreTeam);
                        Comparator<Team> byName = Comparator.comparing(Team::getCountry);
                        Arrays.sort(participant, byAge.thenComparing(byName));
                        Label [] lbl = {l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,L14,l15,l16};
                        Button [] btn = {team1,team2,team3,team4,team5,team6,team7,team8,team9,team10,team11,team12,team13,team14,team15,team16};
                        int k=15;
                        int t=0;
                        int p=1;
                while (k>=0) {
                Team team = participant[k];
                   // System.out.println("hada zebiiiiiiiiiii" + team.getFlag());
                File file = new File(team.getFlag());
                ...
                imageView.setFitHeight(30);
                    ...
                    lbl[t].setText(""+p);
                    btn[t].setText(team.getCountry());
                    btn[t].setGraphic(imageView);
                    k--;
                    t++;
                    p++;
    ...
    public void displayplayers (ActionEvent event) throws IOException{
           
         try {
            
                    FXMLLoader loader=new FXMLLoader(getClass().getResource("DISPLAYPLAYER.fxml"));
                    Parent root = (Parent) loader.load();
                    DisplayPlayer secController=loader.getController();            
                    //secController.goSemiFinale(this.a, this.b, this.c, this.d); 
                    Button button = (Button) event.getSource();
                    String val = button.getText();
                    secController.getValue(val);
                    secController.displayplayers(val);
                    Node node = (Node ) event.getSource();                  
                    Stage stage= (Stage ) node.getScene().getWindow();
                    stage.setScene(new Scene(root));
                    stage.setTitle("Composition des équipes");
                    stage.show();
