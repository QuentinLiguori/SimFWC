...
import static core.WorldCup.initHats;
import data.Coach;
...
//    
    ...
    public void initialize(URL url, ResourceBundle rb) {
        String bip = "C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\image\\uffa.mp3";
       ...
       //----------------------------------------------------------------------------------------
                ...
                FadeTransition podiums = new FadeTransition(Duration.seconds(5), parentContainer);
        ...
        try {
           VBox box  =  FXMLLoader.load(getClass().getResource(("FXML.fxml")));
          ...
          try {
                    FXMLLoader loader=new FXMLLoader(getClass().getResource("FXMLTrieTeam.fxml"));
                    Parent root = (Parent) loader.load();
            
                    FXMLTrieTeamController secController=loader.getController();            
                    secController.classement();
     ...
     @FXML
    void goSee(ActionEvent event) throws IOException {
    ...
    void startSimulation(ActionEvent event) throws IOException {
        /*
        System.out.println("slm ya 9ahba----------------------------------------------------------------------------------------------------------------------- ");
        ...
        */
		...
		Team uruguay = new Team("4-3-3", "Uruguay", uruguay_players, coach_uruguay, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\uruguay-flag-icon-32.png");
		...
		Player chili_players[] = { bravo, cortes, arias, diaz, roco, jara, medel, maripan, isla, beausejour, valdivia,vidal, aranguiz, puch, pulgar, silva, diaz2, vargas, sanchez, castillo, fuenzalida, paredes, fernandes };
		Coach rueda = new Coach("Reinaldo", "Rueda", 63, "colombien", 3);
		Coach coach_chili[] = { rueda };
		Team chili = new Team("5-3-1", "Chili", chili_players, coach_chili, "defensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\chile-flag-icon-32.png");
	...
	Player[] poland_players = { szczesny, majecki, skorupski, kedziora, glik, bednarek, rybus, cionek, reca,
		...
		Team poland = new Team("4-3-4", "Poland", poland_players, poland_coachs, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\poland-flag-icon-32.png");
	...
	Player[] sweden_players = {johnsson, nordfelt, olsen, lustig, lindelof, granqvist, bengtsson, augustinsson,
		...
		Team sweden = new Team("4-4-2", "Swede", sweden_players, sweden_coachs, "defensive","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\sweden-flag-icon-32.png");
		...
		Team france = new Team(" 4-2-3-1 ", "France ", france_players, coach_france, " équilibré ","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\france-flag-icon-32.png");
		...
		Team argentin = new Team(" 4-3-3 ", " Argentine ", argentin_players, coach_argentin, " offensif ","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\argentina-flag-icon-32.png");
	...
	Player[] portugal_players = { patricio, sa, beto, pepe, dias, guerreiro, pereira, rui, fonte, cancelo, pereiraD,
		...
		Team portugal = new Team("4-4-2", "Portugal", portugal_players, portugal_coachs, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\portugal-flag-icon-32.png");
	...
	Player chiesa = new Player("Chiesa", "Federico", 22, 70, 175, "attaquant", 65, 28, 48, 81, 55, 76, 71, 27);
		...
		Team italy = new Team("4-4-2", "Italy", italy_players, italy_coachs, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\italy-flag-icon-32.png");
		...
		// espagne
			...
			Team spain = new Team("4-3-3", "Spain", spain_players, coach_spain, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\spain-flag-icon-32.png");
			...
			Team bresil = new Team("4-3-4", "Brasil", bresil_players, coach_bresil, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\brazil-flag-icon-32.png");
		...
		Team belgique = new Team("4-5-1", "Belgique", belgique_players, coach_belgique, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\belgium-flag-icon-32.png");
		...
		Team algeria = new Team("4-4-3", "Algerie", algeria_players, coach_algeria, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\algeria-flag-icon-32.png");
		...
		Team germany = new Team("4-3-3", "Germany", germany_players, coach_germany, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\germany-flag-icon-32.png");
		...
		Team england = new Team("4-3-3", "England", england_players, coach_england, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\england-flag-icon-32.png");
		// -------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		Team morocco = new Team("4-3-3", "Morocco", morocco_players, coach_morocco, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\morocco-flag-icon-32.png");
		...
		Team netherlands = new Team("4-3-3", "Netherlands", netherlands_players, coach_netherlands, "offensif","C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\netherlands-flag-icon-32.png");
		...
		Hat hat1 = new Hat(participant[0], participant[1], participant[2], participant[3]);
		Hat hat2 = new Hat(participant[4], participant[5], participant[6], participant[7]);
		Hat hat3 = new Hat(participant[8], participant[9], participant[10], participant[11]);
		Hat hat4 = new Hat(participant[12], participant[13], participant[14], participant[15]);
		...
		System.out.println("------------------------------------");
               ...
               GroupStage group1 = new GroupStage(hat1.getTeam1(), hat2.getTeam1(), hat3.getTeam1(), hat4.getTeam1());
		GroupStage group2 = new GroupStage(hat1.getTeam2(), hat2.getTeam2(), hat3.getTeam2(), hat4.getTeam2());
		GroupStage group3 = new GroupStage(hat1.getTeam3(), hat2.getTeam3(), hat3.getTeam3(), hat4.getTeam3());
		GroupStage group4 = new GroupStage(hat1.getTeam4(), hat2.getTeam4(), hat3.getTeam4(), hat4.getTeam4());
		...
		arry.add(group4.getSecond());
                        ...
                        FXMLLoader loader=new FXMLLoader(getClass().getResource("Hats.fxml"));
                        Parent root = (Parent) loader.load();

                        HatsController secController=loader.getController();
                         secController.hats(hat1, hat2, hat3, hat4 , arry, group1 , group2 , group3 , group4);
                     ...
                     /*
                                ...
                                HatsController secController=loader.getController();
                                //secController.transfer();
                               // secController.myFunction(group1.getTeam1().getCountry(),    group1.getTeam2().getCountry(),   group1.getTeam3().getCountry(),    group1.getTeam4().getCountry(),     group2.getTeam1().getCountry(),  group2.getTeam2().getCountry()    ,   group2.getTeam3().getCountry()    ,group2.getTeam4().getCountry()       ,group3.getTeam1().getCountry() ,group3.getTeam2().getCountry()     ,group3.getTeam3().getCountry()  ,group3.getTeam4().getCountry()    ,group4.getTeam1().getCountry()    ,group4.getTeam2().getCountry(),group4.getTeam3().getCountry(),group4.getTeam4().getCountry()    );
                                secController.hats(hat1, hat2, hat3, hat4 , arry, group1 , group2 , group3 , group4);
           ...
           if (node.getAccessibleText() != null){
               node.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) ->   {
                  ...
                  //  GroupeStageController secController=loader.getController();
                   // secController.myFunction(hat1.getTeam1().getCountry(),hat1.getTeam2().getCountry(),hat1.getTeam3().getCountry(),hat1.getTeam4().getCountry(),hat2.getTeam1().getCountry(),hat2.getTeam2().getCountry(),hat2.getTeam3().getCountry(),hat2.getTeam4().getCountry() ,hat3.getTeam1().getCountry() ,hat3.getTeam2().getCountry(),hat3.getTeam3().getCountry(),hat3.getTeam4().getCountry(),hat4.getTeam1().getCountry(),hat4.getTeam2().getCountry(),hat4.getTeam3().getCountry(),hat4.getTeam4().getCountry()  , group1.getFirst().getCountry() ,  group1.getSecond().getCountry() ,  group2.getFirst().getCountry()  ,  group2.getSecond().getCountry()  , group3.getFirst().getCountry() ,  group3.getSecond().getCountry() , group4.getFirst().getCountry() ,  group4.getSecond().getCountry()  );

                    Stage stage=new Stage();
                    stage.setScene(new Scene(root));
                    stage.setTitle("group stage");
