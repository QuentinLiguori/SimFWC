...
public class DisplayPlayer {
    ...
    private String val2;
            ...
            public void displayplayers(String value) throws IOException{
                /*
                                        InputStream inputback = getClass().getResourceAsStream("C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\back.png");
                        Image imageback = new Image(inputback);
                        ImageView imageViewabck = new ImageView(imageback);
                        imageViewabck.setFitWidth(30);
                        imageViewabck.setFitHeight(30);
                        back.setGraphic(imageViewabck);
                        */
                
                  File file = new File("C:\\Users\\TAREK\\Documents\\NetBeansProjects\\JavaFXApplication10\\src\\Flag\\back.png");
                Image imageback = new Image(file.toURI().toString());
                ImageView imageViewabck = new ImageView(imageback);
                imageViewabck.setFitWidth(40);
                imageViewabck.setFitHeight(30);
                back.setGraphic(imageViewabck);
	...
	Player chiesa = new Player("Chiesa", "Federico", 22, 70, 175, "attaquant", 65, 28, 48, 81, 55, 76, 71, 27);
		...
		Team[] participant = { chili, uruguay, italy, portugal, sweden, poland, france, argentin, netherlands, morocco,
            ...
            if( value == participant[i].getCountry()){
              Player[] tab =  participant[i].getPlayers();
              Button [] tbutton = {Button1,Button2,Button3,Button4,Button5,Button6,Button7,Button8,Button9,Button10,Button12,Button11,Button13,Button14,Button15,Button16,Button17,Button18,Button19,Button20,Button21,Button22,Button23};
              
              int k=0;
              int t=0;
               
                while(k<tbutton.length ){
                    
                    System.out.println(tbutton[k].getText()+tab[t].getName());
                    if(k<11){
                    tbutton[k].setStyle("-fx-background-color: transparent;");
                    }
                    tbutton[k].setText(tab[t].getName());
                    k++;
                    t++;
                }
...
//                
    ...
    public void infoPlayer(ActionEvent event) throws IOException{
        
         try {
                    FXMLLoader loader=new FXMLLoader(getClass().getResource("FXMLINFOSPLAYER.fxml"));
                    Parent root = (Parent) loader.load();
            
                    FXMLINFOSPLAYERController secController=loader.getController();            
                     //secController.goSemiFinale(this.a, this.b, this.c, this.d); 
                    Button button = (Button) event.getSource();
                    String val = button.getText();
                    //secController.getValue(val2);
                    secController.displayInfo(val);
                    ...
                    stage.show();
                       ...
                       java.util.logging.Logger.getLogger(FXMLTrieTeamController.class.getName()).log(Level.SEVERE, null, ex);
                   }

    }
    
    
        public void backclassement(ActionEvent event) throws IOException{
