...
public class GroupStage {
	...
	private Team second;
        ...
        private ArrayList <Team> tab = new ArrayList<Team>();
        
        private ArrayList<Match> contentMatch = new ArrayList<Match>();
	...
	public void qualification() {
		...
		addPoints(firstTurn2);
                contentMatch.add(firstTurn);
                contentMatch.add(firstTurn2);
		...
		addPoints(secondTurn2);
                contentMatch.add(secondTurn);
                contentMatch.add(secondTurn2);
		...
		addPoints(thirdTurn2);	
                contentMatch.add(thirdTurn);
                contentMatch.add(thirdTurn2);
	...
	public void setSecond(Team second) {
        ...
        public ArrayList<Team> getTab(){
            return tab;
        }
        public ArrayList<Match> getContentMatch(){
            return contentMatch;
        }
